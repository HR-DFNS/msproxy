...
var _InfoList = __webpack_require__(56);
...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      _axios2.default.get('/api/restaurants/' + id + '/sidebar').then(function (response) {
        that.setState({
    ...
    value: function render() {
      if (!this.state.restaurant) {
        ...
        return _react2.default.createElement(
          'div',
          { className: 'sidebar-flexbox-col sidebar-app' },
          _react2.default.createElement(_InfoList.InfoList, { restaurant: this.state.restaurant })
        );
      }
    }
  }]);
...
module.exports = {"_args":[[{"raw":"axios@^0.18.0","scope":null,"escapedName":"axios","name":"axios","rawSpec":"^0.18.0","spec":">=0.18.0 <0.19.0","type":"range"},"/home/ubuntu/map-side-bar"]],"_from":"axios@>=0.18.0 <0.19.0","_id":"axios@0.18.0","_inCache":true,"_location":"/axios","_nodeVersion":"6.9.5","_npmOperationalInternal":{"host":"s3://npm-registry-packages","tmp":"tmp/axios_0.18.0_1519082934092_0.24234210178813442"},"_npmUser":{"name":"emilyemorehouse","email":"emilyemorehouse@gmail.com"},"_npmVersion":"3.10.10","_phantomChildren":{},"_requested":{"raw":"axios@^0.18.0","scope":null,"escapedName":"axios","name":"axios","rawSpec":"^0.18.0","spec":">=0.18.0 <0.19.0","type":"range"},"_requiredBy":["/"],"_resolved":"https://registry.npmjs.org/axios/-/axios-0.18.0.tgz","_shasum":"32d53e4851efdc0a11993b6cd000789d70c05102","_shrinkwrap":null,"_spec":"axios@^0.18.0","_where":"/home/ubuntu/map-side-bar","author":{"name":"Matt Zabriskie"},"browser":{"./lib/adapters/http.js":"./lib/adapters/xhr.js"},"bugs":{"url":"https://github.com/axios/axios/issues"},"bundlesize":[{"path":"./dist/axios.min.js","threshold":"5kB"}],"dependencies":{"follow-redirects":"^1.3.0","is-buffer":"^1.1.5"},"description":"Promise based HTTP client for the browser and node.js","devDependencies":{"bundlesize":"^0.5.7","coveralls":"^2.11.9","es6-promise":"^4.0.5","grunt":"^1.0.1","grunt-banner":"^0.6.0","grunt-cli":"^1.2.0","grunt-contrib-clean":"^1.0.0","grunt-contrib-nodeunit":"^1.0.0","grunt-contrib-watch":"^1.0.0","grunt-eslint":"^19.0.0","grunt-karma":"^2.0.0","grunt-ts":"^6.0.0-beta.3","grunt-webpack":"^1.0.18","istanbul-instrumenter-loader":"^1.0.0","jasmine-core":"^2.4.1","karma":"^1.3.0","karma-chrome-launcher":"^2.0.0","karma-coverage":"^1.0.0","karma-firefox-launcher":"^1.0.0","karma-jasmine":"^1.0.2","karma-jasmine-ajax":"^0.1.13","karma-opera-launcher":"^1.0.0","karma-safari-launcher":"^1.0.0","karma-sauce-launcher":"^1.1.0","karma-sinon":"^1.0.5","karma-sourcemap-loader":"^0.3.7","karma-webpack":"^1.7.0","load-grunt-tasks":"^3.5.2","minimist":"^1.2.0","sinon":"^1.17.4","typescript":"^2.0.3","url-search-params":"^0.6.1","webpack":"^1.13.1","webpack-dev-server":"^1.14.1"},"directories":{},"dist":{"shasum":"32d53e4851efdc0a11993b6cd000789d70c05102","tarball":"https://registry.npmjs.org/axios/-/axios-0.18.0.tgz","fileCount":40,"unpackedSize":307840},"gitHead":"d59c70fdfd35106130e9f783d0dbdcddd145b58f","homepage":"https://github.com/axios/axios","keywords":["xhr","http","ajax","promise","node"],"license":"MIT","main":"index.js","maintainers":[{"name":"mzabriskie","email":"mzabriskie@gmail.com"},{"name":"nickuraltsev","email":"nick.uraltsev@gmail.com"}],"name":"axios","optionalDependencies":{},"readme":"ERROR: No README data found!","repository":{"type":"git","url":"git+https://github.com/axios/axios.git"},"scripts":{"build":"NODE_ENV=production grunt build","coveralls":"cat coverage/lcov.info | ./node_modules/coveralls/bin/coveralls.js","examples":"node ./examples/server.js","postversion":"git push && git push --tags","preversion":"npm test","start":"node ./sandbox/server.js","test":"grunt test && bundlesize","version":"npm run build && grunt version && git add -A dist && git add CHANGELOG.md bower.json package.json"},"typings":"./index.d.ts","version":"0.18.0"}
...
exports.OpeningHours = exports.InfoListElement = exports.InfoList = undefined;
...
var _OpeningHours = __webpack_require__(57);
...
var InfoList = function InfoList(props) {
  ...
  return _react2.default.createElement(
    'div',
    { className: 'sidebar-flexbox-col sidebar-info-list' },
    _react2.default.createElement(_OpeningHours.OpeningHours, { info: info.openingHours }),
    ...
    _react2.default.createElement(InfoListElement, { info: info.website }),
...
var InfoListElement = function InfoListElement(props) {
  if (!props.info.text) {
    ...
    return _react2.default.createElement(
      'div',
      { className: 'sidebar-flexbox-row sidebar-info-list-element' },
      _react2.default.createElement(
        'div',
        { className: 'sidebar-info-list-element-icon' },
        _react2.default.createElement('i', { className: props.info.icon })
      ),
      _react2.default.createElement(
        'div',
        { className: 'sidebar-info-list-text' },
        _react2.default.createElement(
          'a',
          { className: 'sidebar-anchor', href: props.info.link.url,
...
exports.OpeningHours = _OpeningHours.OpeningHours;
...
exports.Periods = exports.OpeningHours = undefined;
...
var OpeningHours = function (_React$Component) {
  _inherits(OpeningHours, _React$Component);

  function OpeningHours(props) {
    _classCallCheck(this, OpeningHours);

    var _this = _possibleConstructorReturn(this, (OpeningHours.__proto__ || Object.getPrototypeOf(OpeningHours)).call(this, props));
  ...
  _createClass(OpeningHours, [{
    ...
    value: function getOpenNow() {
      ...
      var openNow = _underscore2.default.some(this.props.info.data.periods, function (period) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'sidebar-flexbox-col sidebar-info-list-element' },
        _react2.default.createElement(
          'div',
          { onClick: this.clickHandler.bind(this), className: 'sidebar-flexbox-row sidebar-opening-hours-title' },
          _react2.default.createElement(
            'div',
            { className: 'sidebar-info-list-element-icon' },
            _react2.default.createElement('i', { className: this.props.info.icon })
          ),
          _react2.default.createElement(
            'div',
            { className: 'sidebar-flexbox-row sidebar-info-list-text sidebar-opening-hours-title' },
            _react2.default.createElement(
              'div',
              null,
              _react2.default.createElement(
                'div',
                { className: 'sidebar-periods-element-day sidebar-open-now-text' },
                openNow
              )
            ),
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'div',
                { className: 'sidebar-periods-element-time' },
                timeRange.time1
              ),
              _react2.default.createElement(
                'div',
          ...
          _react2.default.createElement(
            'div',
            { className: 'sidebar-expand-arrow', style: this.state.showPeriods ? { transform: 'rotate(180deg)' } : { transform: 'rotate(0deg)' } },
            _react2.default.createElement('i', { className: 'fas fa-angle-down fa-lg' })
          )
        ),
        _react2.default.createElement(
          'div',
          { className: 'sidebar-flexbox-col sidebar-periods', style: this.state.showPeriods ? { display: 'flex' } : { 'display': 'none' } },
          _react2.default.createElement(Periods, { weekdayText: this.props.info.data.weekday_text })
        )
      );
    }
  }]);
...
var Periods = function Periods(props) {
  var periodDivs = _underscore2.default.map(props.weekdayText, function (period, index) {
    ...
    return _react2.default.createElement(
      'div',
      { key: index, className: 'sidebar-flexbox-col sidebar-periods-element',
        style: { 'fontWeight': weekdayNum === index ? 'bold' : 'normal' } },
      _react2.default.createElement(
        'div',
        { className: 'sidebar-flexbox-row sidebar-periods-element-info' },
        _react2.default.createElement(
          'div',
          { className: 'sidebar-periods-element-day' },
          periodObj.weekday
        ),
        _react2.default.createElement(
          'div',
      ...
      _react2.default.createElement(
        'div',
        { className: 'sidebar-periods-element-info-additional' },
        _react2.default.createElement(
          'div',
          { className: 'sidebar-periods-element-time' },
          periodObj.time2
  ...
  return _react2.default.createElement(
    'div',
    { className: 'sidebar-flexbox-col sidebar-periods' },
    periodDivs
  );
};
